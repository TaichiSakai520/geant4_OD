...
// Constructor /////////////////////////////////////////////////////////////
KLPhysicsList::KLPhysicsList() : G4VUserPhysicsList()
{
...
// Destructor //////////////////////////////////////////////////////////////
KLPhysicsList::~KLPhysicsList()
{
  ;
}

// Construct Particles /////////////////////////////////////////////////////
void KLPhysicsList::ConstructParticle()
{
...
// construct Bosons://///////////////////////////////////////////////////
void KLPhysicsList::ConstructMyBosons()
{
  // pseudo-particles
...
// construct Leptons://///////////////////////////////////////////////////
void KLPhysicsList::ConstructMyLeptons()
{
  // leptons
...
// construct Hadrons://///////////////////////////////////////////////////
void KLPhysicsList::ConstructMyHadrons()
{
  //  mesons
...
void KLPhysicsList::ConstructMyShortLiveds()
{
...
// Construct Processes //////////////////////////////////////////////////////
void KLPhysicsList::ConstructProcess()
{
...
//Transportation ///////////////////////////////////////////////////////////
//#include "KLMaxTimeCuts.hh"
//#include "KLMinEkineCuts.hh"
//#include "G4StepLimiter.hh"

//void KLPhysicsList::AddTransportation() {
...
//  pmanager->AddDiscreteProcess(new KLMaxTimeCuts());
// Energy cuSts to kill charged (embedded in method) particles:
// pmanager->AddDiscreteProcess(new KLMinEkineCuts());
...
void KLPhysicsList::ConstructEM()
{
...
void KLPhysicsList::ConstructOp()
{
  ...
  theCkovProcess->SetMaxBetaChangePerStep(40.0);
  // theCkovProcess->SetMaxBetaChangePerStep(10.0);
  ...
  while ((*theParticleIterator)())
  {
    ...
    if (theCkovProcess->IsApplicable(*particle))
    {
      pmanager->AddProcess(theCkovProcess);
      pmanager->SetProcessOrdering(theCkovProcess, idxPostStep);
    }
  }
}
...
void KLPhysicsList::ConstructHad()
{
  //Elastic models
...
void KLPhysicsList::ConstructGeneral()
{
...
void KLPhysicsList::SetCuts()
{

  if (verboseLevel > 1)
    G4cout << "KLPhysicsList::SetCuts:";
